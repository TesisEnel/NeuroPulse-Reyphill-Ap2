...
interface NeuroPulseApi {
    ...
    //ProgresionSemanal
    @GET("/api/ProgresionSemanals/historial/usuario/{usuarioId}")
    suspend fun getHistorialProgresionSemanal(@Path("usuarioId") usuarioId: Int): List<ProgresionSemanalDto>

    @GET("/api/ProgresionSemanals/ObtenerActual/usuario/{usuarioId}")
    suspend fun getProgresionActual(@Path("usuarioId")usuarioId: Int): ProgresionSemanalDto

    @POST("/api/ProgresionSemanals/ActulizarProgresion/usuario/{usuarioId}")
    suspend fun actualizarProgresion(@Path("usuarioId") usuarioId: Int): Response<Unit>
}